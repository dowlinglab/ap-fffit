...
def init_project():
    ...
    project = signac.init_project("ap-iter4")
    ...
    lh_samples = pd.read_csv("/scratch365/bbefort/ap-fffit/ap-fffit/analysis/csv/uc-lattice-iter4-params.csv", header=0,usecols=[1,2,3,4,5,6,7,8]).values
