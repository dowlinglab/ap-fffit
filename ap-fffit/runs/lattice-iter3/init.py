...
def init_project():
    ...
    project = signac.init_project("lattice-iter3")
    ...
    # Load samples from previous analysis
    samples = pd.read_csv("../../analysis/csv/lattice-iter3-params.csv", index_col=0).values
    ...
    scaled_params = values_scaled_to_real(samples, bounds)
